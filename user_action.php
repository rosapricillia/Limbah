...
if(isset($_POST["action"]))
{
	...
	if($_POST["action"] == 'Add')
	{
		...
		else
		{
			...
			$data = array(
				...
				':admin_type'		=>	$_POST["admin_email"],
				':admin_seksi'		=>  $_POST["admin_seksi"],
				':admin_created_on'	=>	$visitor->get_datetime()
			);

			$visitor->query = "
			INSERT INTO admin_table 
			(admin_name, admin_contact_no, admin_email, admin_password, admin_profile, admin_type, admin_seksi, admin_created_on) 
			VALUES (:admin_name, :admin_contact_no, :admin_email, :admin_password, :admin_profile, :admin_type, :admin_seksi, :admin_created_on)
			";
	...
	if($_POST["action"] == 'Edit')
	{
		...
		else
		{
			...
			$data[':admin_seksi'] = $_POST["admin_seksi"];
